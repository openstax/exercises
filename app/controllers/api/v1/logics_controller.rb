  ...
  module V1
    ...
    class LogicsController < ApiController 
      ...
      resource_description do
        ...
        description <<-EOS
          #{SITE_NAME} uses Javascript to make exercises "dynamic".  Authors write
          small bits of Javascript to compute variables that are substituted into special
          placeholders in the exercise content.  When the Javascript uses the available 
          ...
          browser when they view the exercise &ndash; instead, the Javascript is run in the
          author's browser (during the authoring process).  When a "Logic" attached to an 
          Exercise is saved, the client is responsible for sending along a number of output
          ...
          the author wants to have available in the Exercise content.  There are several 

...
describe "fill_in_the_blank_answers/new" do
  before(:each) do
    assign(:fill_in_the_blank_answer, stub_model(FillInTheBlankAnswer,
      :question_id => 1,
      :pre_content => "MyText",
  ...
  it "renders new fill_in_the_blank_answer form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", fill_in_the_blank_answers_path, "post" do

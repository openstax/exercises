...
describe "true_or_false_answers/new" do
  before(:each) do
    assign(:true_or_false_answer, stub_model(TrueOrFalseAnswer,
      :question_id => 1,
      :content => "MyText",
      :content_html => "MyText",
      :is_true => false,
  ...
  it "renders new true_or_false_answer form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", true_or_false_answers_path, "post" do

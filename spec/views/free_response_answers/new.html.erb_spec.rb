...
describe "free_response_answers/new" do
  before(:each) do
    assign(:free_response_answer, stub_model(FreeResponseAnswer,
      :question_id => 1,
      :content => "MyText",
      :content_html => "MyText",
  ...
  it "renders new free_response_answer form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", free_response_answers_path, "post" do

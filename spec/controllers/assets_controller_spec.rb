...
describe AssetsController do
  ...
  let(:valid_attributes) { { "attachment_file_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved asset as @asset" do
        ...
        post :create, {:asset => { "attachment_file_name" => "invalid value" }}, valid_session
        assigns(:asset).should be_a_new(Asset)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested asset" do
        ...
        Asset.any_instance.should_receive(:update_attributes).with({ "attachment_file_name" => "MyString" })
        put :update, {:id => asset.to_param, :asset => { "attachment_file_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the asset as @asset" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Asset.any_instance.stub(:save).and_return(false)
        put :update, {:id => asset.to_param, :asset => { "attachment_file_name" => "invalid value" }}, valid_session
        assigns(:asset).should eq(asset)
      end

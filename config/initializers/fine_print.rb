...
FinePrint.configure do |config|
  ...
  config.manager_proc = lambda { |user| user.administrator }
  ...
  config.security_transgression_proc = lambda { raise SecurityTransgression }
  ...
  # Default: '/'
  config.sign_contracts_path = '/terms/pose'

...
ActiveRecord::Schema.define(version: 20180807204640) do
  ...
  add_index "favorites", ["user_id", "publication_id"], name: "index_favorites_on_user_id_and_publication_id", unique: true, using: :btree
